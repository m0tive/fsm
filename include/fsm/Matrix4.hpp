...
public:
    ...
    /// This is used when converting to Matrix4 from Real[].
    enum Layout
    {
        kRowMajor = 0,
        kColMajor
    ...
    /// Multiply this Matrix4 with another, using this as the rhs of the
    ///   operation.
    ...
    /// Multiply this Matrix4 with another, using this as the lhs of the
    ///   operation.
    /// \param _rhs - the right hand side of the multiplication
    /// \return A copy of the resulting matrix
